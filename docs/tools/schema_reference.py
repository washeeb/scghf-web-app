...
MODULES = [
    ...
    ("Programmes & impact", ["focus_areas", "focus_area_project", "projects", "project_updates", "project_milestones", "project_locations", "impact_metrics", "impact_metric_values", "beneficiaries", "beneficiary_documents", "beneficiary_notes", "beneficiary_impact_records", "legal_holds", "retention_log", "privacy_test_subjects", "expenditures"]),
    ("Fundraising & payments", ["causes", "cause_updates", "giving_levels", "donations", "donation_items", "donation_receipts", "donors", "donation_plans", "subscriptions", "subscription_charges", "pledges", "sponsorships", "sponsorship_updates", "fundraisers", "receipt_sequences", "payment_transactions", "payment_webhook_events", "refunds", "payouts", "tax_approvals", "reconciliation_runs", "funders", "grants", "grant_obligations", "grant_documents"]),
    ("Shop", ["products", "product_categories", "product_variants", "product_images", "product_reviews", "inventory_movements", "carts", "cart_items", "orders", "order_items", "order_status_histories", "invoices", "invoice_sequences", "product_related", "digital_download_tokens", "shipping_zones", "shipping_rates", "coupons", "coupon_redemptions", "downloads", "regulatory_reviews", "deliveries"]),
    ("Engagement", ["events", "event_registrations", "event_tickets", "volunteer_opportunities", "volunteer_applications", "safeguarding_checks", "volunteers", "issued_tickets", "volunteer_hours", "volunteer_shifts", "contact_messages", "contact_departments", "enquiries", "prayer_requests", "chat_conversations", "chat_messages", "ai_interactions"]),
    ("Communications", ["email_templates", "sms_templates", "whatsapp_templates", "email_logs", "sms_logs", "scheduled_messages", "newsletters", "subscribers", "newsletter_subscriptions", "newsletter_campaigns", "campaign_recipients", "sms_broadcasts", "suppressions", "inbound_webhook_events", "notification_logs"]),
