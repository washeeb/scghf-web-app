...
MODULES = [
    ...
    ("Engagement", ["events", "event_registrations", "event_tickets", "volunteer_opportunities", "volunteer_applications", "safeguarding_checks", "volunteers", "issued_tickets", "volunteer_hours", "volunteer_shifts", "contact_messages", "contact_departments", "enquiries", "prayer_requests", "chat_conversations", "chat_messages"]),
