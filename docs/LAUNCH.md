...
| X6c | Every launch placeholder replaced: the programmes, appeals, news, events, testimonials, goals and gallery `LaunchContentSeeder` wrote carry a marker until a person replaces them with the real thing | Comms + Programmes | LC *Launch placeholders replaced* |
