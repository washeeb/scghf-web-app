    ...
    <div class="mx-auto w-full max-w-4xl px-4 py-10">
                ...
                @foreach ($tabs as $tab)
                    ...
                    <li>
                        <a
                            ...
                            @class([
                                'inline-block border-b-2 px-4 py-2.5 text-sm font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--focus)]',
                                'border-[var(--brand-primary)] text-[var(--text)]' => $isCurrent,
                                'border-transparent text-[var(--text-muted)] hover:text-[var(--text)]' => ! $isCurrent,
                            ])
                        >{{ $tab['label'] }}</a>
                    </li>
                @endforeach
        ...
        <div class="mt-8 space-y-6">
            ...
            @unless ($user?->hasVerifiedEmail())
                ...
                <div role="status" class="rounded-md border border-[var(--brand-secondary)] bg-[var(--surface)] px-4 py-3 text-sm text-[var(--text)]">
