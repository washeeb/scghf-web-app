{{--
    403. Branded, and inside the site's own layout.
...
<x-layouts.app title="Not allowed">
    <div class="mx-auto max-w-2xl px-4 py-24 text-center">
        ...
        <h1 class="mt-3 text-3xl font-semibold tracking-tight text-[var(--text)]">{{ __('Not allowed') }}</h1>
        <p class="mt-4 text-[var(--text-muted)]">{{ __('You do not have permission to view this page. If you think you should, ask whoever administers the site.') }}</p>
