...
--}}
<x-layouts.app :noindex="true" title="Something went wrong">
    <div class="mx-auto max-w-2xl px-4 py-24 text-center">
        ...
        <h1 class="mt-3 text-3xl font-semibold tracking-tight text-[var(--text-primary)]">{{ __('Something went wrong') }}</h1>
